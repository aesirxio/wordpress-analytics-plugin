...
Class AesirX_Analytics_Get_Visitor_Consent_List extends AesirxAnalyticsMysqlHelper
{
    function aesirx_analytics_mysql_execute($params = [])
    {
        ...
        $consents_sql = $wpdb->prepare($consents_sql, $params['uuid'], date('Y-m-d H:i:s'));
